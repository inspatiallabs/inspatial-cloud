...
const getSettingsInfo = new CloudAction("getSettingsInfo", {
...
const getSettings = new CloudAction("getSettings", {
  label: "Get Settings",
...
const updateSettings = new CloudAction("updateSettings", {
...
const runSettingsAction = new CloudAction("runSettingsAction", {
